...
namespace IndoSlang
{
    public partial class Module4 : System.Web.UI.Page
    {
        ...
        private int userId;
        private const int ModuleOrder = 4;
        private const int PreviousModuleOrder = 3;
        ...
        // Block access if Module 3 not completed
        ...
        protected void btnSaveResult_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(passed ? "~/Module5.aspx" : "~/Module4.aspx");
        }
