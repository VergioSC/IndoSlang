<%@ Page Title="Module 3 — Elementary" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Module3.aspx.cs" Inherits="IndoSlang.Module3" %>
        ...
        <div class="dashboard-main">
            <div class="topbar">
                <div class="topbar-left">
                    ...
                    <span class="topbar-title">Module 3</span>
                </div>
            ...
            <div class="module-content">
                ...
                <div class="intro-card" id="introCard">
                    ...
                    <h1 class="intro-title">Level 2 - Elementary<br />Module 3 - See Slang in a Chat</h1>
                    <p class="intro-sub">Hey congrats! you're an elementary student now</p>
                    <p class="intro-desc">In this level, you'll start seeing them in full sentences &mdash; filling in blanks, translating real phrases, and figuring out what people actually mean.</p>
                    <p class="intro-desc">By the end of Level 2, you'll be able to read and understand everyday Indonesian slang sentences, not just single words.</p>
                    <button type="button" class="btn-start-quiz" onclick="startQuiz()">Got it, let's start!</button>
                </div>

                <div class="empty-card" id="emptyCard">
                    <strong>No questions found for Module 3.</strong><br />
                    Insert rows into the <strong>Question</strong> table where ModuleID belongs to Module 3.
                </div>

                <div id="quizBlock" style="display:none">
                    <div class="module-header">
                        <span class="module-badge">Module 3 &middot; Elementary</span>
                        <h1>See Slang in a Chat</h1>
                        <p>Fill in blanks, translate phrases, and figure out what slang means from real conversations.</p>
                    </div>
                ...
                <div class="completion-card" id="completionCard">
                    ...
                    <div class="result-actions" id="completionActions">
                ...
                <div class="summary-card" id="summaryCard">
                    <h2 class="summary-title">You just completed Module 3!</h2>
                    <p class="summary-sub">Here are the slang words you practised in this module</p>
                    <div class="vocab-grid">
                        <div class="vocab-item"><span class="vocab-word">Laper</span><span class="vocab-meaning">Hungry (casual)</span></div>
                        <div class="vocab-item"><span class="vocab-word">Capek</span><span class="vocab-meaning">Tired / exhausted</span></div>
                        <div class="vocab-item"><span class="vocab-word">Nyebelin</span><span class="vocab-meaning">Annoying / irritating</span></div>
                        <div class="vocab-item"><span class="vocab-word">Rebahan</span><span class="vocab-meaning">Lying down lazily</span></div>
                        <div class="vocab-item"><span class="vocab-word">Cuek</span><span class="vocab-meaning">Cold / indifferent</span></div>
                        <div class="vocab-item"><span class="vocab-word">Bete</span><span class="vocab-meaning">Annoyed / bad mood</span></div>
                    </div>
    ...
    <script>
        ...
        function showCompletion() {
            ...
            if (passedModule) {
                ...
                document.getElementById('completionMsg').textContent = 'You got ' + score + ' out of ' + questions.length + ' correct. You\'re ready for the Elementary Challenge!';
                ...
                document.getElementById('completionMsg').textContent = 'You got ' + score + ' out of ' + questions.length + ' correct. You need at least ' + PASS_SCORE + '/' + questions.length + ' to unlock Module 4. Review the slang you missed and try again — you\'re almost there!';
        ...
        function showSummary() {
            ...
            if (passedModule) {
                var btn = document.createElement('button');
                btn.type = 'button'; btn.className = 'btn-next-module'; btn.textContent = 'Go to Module 4 →';
        ...
        function renderChatWindow(data) {
            ...
            for (var i = 0; i < msgs.length; i++) {
                ...
                row.className = 'chat-msg ' + (msg.side || 'left');
                if (msg.name) {
