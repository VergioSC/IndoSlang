...
namespace IndoSlang
{
    public partial class Module2 : System.Web.UI.Page
    {
        ...
        private int userId;
        private const int ModuleOrder = 2;
        private const int PreviousModuleOrder = 1;
        ...
        protected void btnSaveResult_Click(object sender, EventArgs e)
        {
            ...
            // unlock Elementary level when passed
            if (passed)
            {
                using (SqlConnection conn = DBHelper.GetConnection())
                {
                    string q = "UPDATE [User] SET CurrentLevel = 'Elementary' WHERE UserID = @UserID";
                ...
                Session["AssignedLevel"] = "Elementary";
            }

            Response.Redirect(passed ? "~/Module3.aspx" : "~/Module2.aspx");
        }
