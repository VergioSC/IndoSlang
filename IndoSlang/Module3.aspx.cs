...
namespace IndoSlang
{
    public partial class Module3 : System.Web.UI.Page
    {
        ...
        private int userId;
        private const int ModuleOrder = 3;
        private const int PreviousModuleOrder = 2;
        ...
        // Block access if Module 2 not completed
        ...
        protected void btnSaveResult_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(passed ? "~/Module4.aspx" : "~/Module3.aspx");
        }
